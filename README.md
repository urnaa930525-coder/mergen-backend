...
- `db.js` — Postgres схем
- `routes/auth.js` — бүртгэл/нэвтрэх
- `routes/agent.js` — agent тохиргоо, харилцан ярианы түүх
- `routes/chat.js` — widget-ээс ирэх chat хүсэлт, Claude API дуудна
- `public/index.html` — dashboard (signup/login, тохиргоо)
- `public/widget.js` — бизнесүүдийн сайтад буулгах embed script
